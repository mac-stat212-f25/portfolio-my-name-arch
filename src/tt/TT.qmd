...
#The data set provided to us provides information about chess rankings in the month of september.Within the data set, we have Sex, Nationality, Rating, Games, and Bday year. We also find the title that they may hold. This title depends on gender. There is also space for other titles. The research question that I have come up with is is there a relationship between your rating and the eara within which you were born. How I am going to show this is with a bar graph, it will have the decade along the x axis and along the y axis, the count of the occurences of each title.
# Install and load necessary libraries
library(tidyverse)

# Load the dataset
# Note the "~/" at the beginning and the corrected "portfolio" spelling
...
ggplot(fide_top_titles, aes(x = factor(decade), fill = title)) +
  # Add the 'width' argument here as well
  geom_bar(position = "dodge", width = .5) +
  geom_text(
    stat = "count",
    aes(label = after_stat(count)),
    # Important: Match the dodge width here so labels stay centered
